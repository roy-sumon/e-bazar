      ...
      <div className="bg-gradient-to-r from-rose-500 via-rose-600 to-amber-600 rounded-2xl sm:rounded-3xl p-4 sm:p-8 text-white shadow-xl">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 sm:gap-4 pb-4 sm:pb-6 border-b border-white/20">
          <div className="flex items-center gap-2.5 sm:gap-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center text-white shadow-inner shrink-0">
              <Flame className="w-5 h-5 sm:w-7 sm:h-7 fill-white animate-bounce" />
            </div>
            <div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="bg-white text-rose-600 text-[10px] sm:text-xs font-black px-2 sm:px-2.5 py-0.5 rounded-full uppercase">
                  Limited Time
                </span>
              </div>
          ...
          {/* Live Timer Boxes */}
          <div className="flex items-center gap-1.5 sm:gap-2 bg-black/30 backdrop-blur-md p-2 sm:p-2.5 rounded-xl sm:rounded-2xl border border-white/10 self-stretch sm:self-auto justify-center">
            <Clock className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-300 mr-1" />
        ...
        {/* Flash Sale Product Cards (2 cols on mobile, 4 on desktop) */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-5 pt-4 sm:pt-6">
          {flashProducts.map((product) => {
            ...
            return (
              ...
              >
                ...
                {/* Product Image */}
                <div
                  className="relative aspect-square rounded-lg sm:rounded-xl overflow-hidden bg-slate-100 mb-2 sm:mb-3 cursor-pointer"
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    {vendor && (
                      <button
                        ...
                        className="text-[10px] sm:text-[11px] font-semibold text-brand-600 hover:text-brand-800 hover:underline line-clamp-1 mb-0.5 sm:mb-1 text-left"
                      >
                        {vendor.name}
                      </button>
                    )}
                    ...
                    <h3
                      onClick={() => setQuickViewProduct(product)}
                      className="text-xs sm:text-sm font-bold text-slate-900 hover:text-brand-600 cursor-pointer line-clamp-2 mb-1 sm:mb-2 leading-tight sm:leading-snug"
                    >
                      {product.title}
                    </h3>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mb-2.5 sm:mb-3.5">
                      <div className="flex justify-between text-[10px] sm:text-[11px] font-semibold text-slate-500 mb-1">
                        <span>Sold: {claimed}%</span>
                        <span className="text-amber-600 hidden xs:inline">Few left!</span>
                      </div>
