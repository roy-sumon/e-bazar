    ...
    <section id="product-catalog" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3 self-end md:self-auto">
          ...
          <button
            ...
            className="lg:hidden flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white border border-slate-300 text-slate-700 text-xs font-bold"
          >
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white border border-slate-200 text-slate-800 text-xs font-bold py-2.5 pl-3.5 pr-8 rounded-xl shadow-sm focus:outline-none cursor-pointer"
            >
              <option value="featured">Sort by: Featured & Recommended</option>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <aside
          ...
          } space-y-6 bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm h-fit sticky top-28`}
        >
